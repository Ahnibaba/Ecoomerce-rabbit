        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
             <button
               ...
               className={`size-8 rounded-full border border-gray-300 cursor-pointer transition
               hover:scale-105 ${filters.color === color ?
        ...
        {sizes.map((size) => (
          <div key={size} className="flex items-center mb-1">
            <input
              ...
              className="mr-2 size-4 text-blue-400 focus:ring-blue-400 border-gray-300"
            />
