    ...
    try {
      ...
      console.log("2")
       ...
       if(paymentStatus === "paid") {
        ...
        console.log("Error in checkOutPay function", error)
        res.status(500).json({ message: "Server Error" })
    }
}
  ...
  try {
    ...
    if(checkout.isPaid && !checkout.isFinalized) {
      ...
      res.status(400).json({ message: "Checkout is not paid" })
        ...
        console.log("Error in finalizeCheckout function", error.message)
        res.status(500).json({ message: "Server Error" })
    }
}
...
module.exports = { checkout, checkOutPay, finalizeCheckout  }